    ...
    function _replace_entities(text, entities) {
        ...
        urls.forEach(function(url) {
            try {
                ...
                if(url.expanded_url !== undefined && url.expanded_url.match(/http:\/\/twitpic.com/)) {
                    var extraMediaUrl = 'http://twitpic.com/show/large/'+url.expanded_url.replace(/http:\/\/twitpic.com/,'')
                    console.log(extraMediaUrl);
                    text += '<div class="tweet-media"><img src="'+extraMediaUrl+'" style="width:90%" /></div>';
                }
            } catch(e) {
                console.log(e);
            }                
