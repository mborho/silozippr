...
return this.connector.deleteDocs(t).response(this, "docsDeleted"), !0;
},
deleteSingleItem: function(e, t) {
return this.connector.deleteDocs(t).response(this, "singleDocDeleted"), !0;
},
...
t.success == 1 && (this.$.toc.removeDocs(t.deleted), this.$.mainline.changeSourceSum(-1));
},
...
name: "list",
kind: "PulldownList",
classes: "enyo-fit pulldown-list",
fit: !0,
...
clearItems: function() {
this.results = [], this.$.list.setCount(0), this.$.header.setShowing(!1), this.render();
},
loadList: function() {
var e = {
format: "json"
...
build: function(e, t) {
var n = t.docs;
this.handleSpinner(!1), this.pulled && this.$.list.completePull(), n.length == 0 && this.loadStartView(), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem"
}), this.lastDoc = n.slice(n.length - 2)) : (this.startDoc = !1, this.lastDoc = n.slice(n.length - 1)), this.skey && this.$.header.setShowing(!0), t.append ? (this.results.pop(), this.results = this.results.concat(n), this.$.list.setCount(this.results.length), this.$.list.refresh()) : (this.results = n, this.$.list.setCount(this.results.length), this.$.list.reset(), this.render()), this.$.list.show();
},
setupItem: function(e, t) {
var n = this.results[t.index];
n.deleted == 1 ? this.$.item.setShowing(!1) : (this.$.item.setShowing(!0), n.kind == "NewsItem" ? (this.$.newsDate.setContent(n.date), this.$.newsTitle.setContent(n.title), this.$.newsTitle.setAttribute("href", n.href), this.$.newsBody.setContent(n.body), this.$.newsPublisher.setContent(this.skey ? "" : n.publisher), this.$.newsItem.setShowing(!0), this.$.tweetItem.setShowing(!1), this.$.moreItem.setShowing(!1)) : n.kind == "TweetItem" ? (this.$.tweetDate.setContent(n.date), this.$.tweetByline.setContent(n.byline), this.$.tweetBody.setContent(n.body), this.$.tweetItem.setShowing(!0), this.$.newsItem.setShowing(!1), this.$.moreItem.setShowing(!1)) : n.kind == "MoreItem" && (this.$.newsItem.setShowing(!1), this.$.tweetItem.setShowing(!1), this.$.moreItem.setShowing(!0)));
},
openUrl: function(e, t) {
var n = this.results[t.index];
return window.open(n.href, "", ""), !0;
},
reload: function() {
...
}), this.doDeleteItems(n), this.$.list.hide();
},
...
return this.results[n].deleted = !0, this.$.list.prepareRow(n), this.$.list.renderRow(n), this.$.list.lockRow(), this.doDeleteSingleItem(i), this.hideLineAction(), !0;
},
...
pullRelease: function() {
this.pulled = !0, setTimeout(enyo.bind(this, "reload"), 1e3);
},
pullComplete: function() {
this.handleSpinner(!1), this.pulled = !1, this.$.list.reset();
},
