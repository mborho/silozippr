...
this.clearItems(), this.skey = !1, this.source = !1, this.count = 0, this.startDoc = !1, this.$.sourceSum.setShowing(!1), this.loadList();
},
...
build: function(e, t) {
var n = t.docs;
this.handleSpinner(!1), this.skey && !this.$.header.getShowing() && (this.$.header.setShowing(!0), this.render()), n.length == 0 && this.skey && this.loadStartView(), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem",
title: "<b>more</b>"
