...
t ? this.loadSource(null, t) : this.loadMainline();
},
...
e.success !== !0 && t.error("deleting failed"), e.all === !0 ? console.log("Controller.checkNext();") : (t.$.mainline.reload(), t.$.toc.removeDocs(e.deleted), t.$.mainline.changeSourceSum(-e.deleted.length));
...
build: function(e, t) {
var n = t.docs;
this.handleSpinner(!1), this.skey && !this.$.header.getShowing() && (this.$.header.setShowing(!0), this.render()), n.length == 0 && this.skey && (this.clearItems(), this.clearState(), this.doLoadNextSource()), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem",
title: "<b>more</b>"
...
return t.sum > 0 ? (this.$.sourceSum.setContent(t.sum), this.$.sourceSum.setShowing(!0)) : (this.$.sourceSum.setShowing(!1), this.$.sourceSum.setContent("-")), !0;
},
...
return this.results.length > 0 ? this.results[0] : !1;
}
});
