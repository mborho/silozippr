...
arrange: function(a, b) {
var c = this.colWidth, d = this.colHeight, e = Math.max(1, Math.floor(this.containerBounds.width / c)), f;
...
onLoadSource: "loadSourceFromList"
}, {
kind: "FittableRows",
fit: !0,
components: [ {
...
(a.kind == "TweetItem" || a.kind == "NewsItem" || a.name == "more") && a.destroy();
}), this.$.itemList.render();
},
clearMoreItem: function() {
var a = this.$.itemList.getComponents(), b = a.slice(a.length - 1);
b.length > 0 && b[0].name === "more" && b[0].destroy();
},
loadList: function() {
var a = {
format: "json"
};
this.skey ? a.id = this.skey : this.$.header.hide(), this.startDoc && (a.startkey = JSON.stringify(this.startDoc)), (new enyo.Ajax({
url: this.owner.getApiEndpoint() + "/api/list/docs"
})).go(a).response(this, "build");
},
loadStartView: function() {
this.clearItems(), this.skey = !1, this.count = 0, this.startDoc = !1, this.loadList();
},
loadNextPage: function(a, b) {
this.loadList();
},
loadSourceFromList: function(a, b) {
this.loadSource(b);
},
loadSource: function(a) {
this.clearItems(), this.skey = a.skey, this.startDoc = !1, this.$.header.setContent(a.title), this.$.header.show(), this.loadList();
},
manageMoreItem: function(a) {
a === !0 && this.$.itemList.createComponent({
name: "more",
kind: "MoreItem"
});
},
build: function(a, b) {
var c = b.docs, d = b.append;
d && this.clearMoreItem(), enyo.forEach(c, this.addItem, this), this.lastDoc = c.slice(c.length - 1), b.more !== !1 ? (this.startDoc = b.more, this.manageMoreItem(!0)) : this.startDoc = !1, this.$.itemList.render();
},
addItem: function(a) {
a.combined = !this.skey, this.$.itemList.createComponent(a), this.count++;
}
});
...
enyo.Signals.send("onLoadSource", a);
}
});
