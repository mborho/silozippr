...
enyo.path.addPaths({layout: "/home/martin/ubuntuone/dev/silozippr-client/enyo/tools/../../lib/layout/", onyx: "/home/martin/ubuntuone/dev/silozippr-client/enyo/tools/../../lib/onyx/", onyx: "/home/martin/ubuntuone/dev/silozippr-client/enyo/tools/../../lib/onyx/source/"});
...
rendered: function() {
this.inherited(arguments), this.isNarrow() && this.$.contentPanel.setIndex(1);
},
loadToc: function(e) {
return this.connector.loadToc().response(this.$.toc, "build"), !0;
},
setTotalSum: function(e, t) {
return this.$.totalSum.setContent(t.sum), !0;
},
loadMainline: function(e, t) {
return this.connector.loadList(t).response(this.$.mainline, "build"), !0;
},
loadNextSource: function(e) {
var t = this.$.toc.getNextSource();
t || this.loadMainline();
},
...
showItemOptions: function(e, t) {
this.$.tools.open || this.$.tools.display(t);
},
optionsClosed: function(e, t) {
this.$.mainline.optionsClosed();
},
shortUrl: function(e, t) {
this.connector.shortUrl(t.url).response(t.callback);
},
sendTweet: function(e, t) {
t.retweet === !0 ? this.connector.sendRetweet(t.id).response(this.$.tools, "retweetSended") : this.connector.sendTweet(t.text).response(this.$.tools, "tweetSended");
},
...
e.success !== !0 && t.error("deleting failed"), e.all === !0 ? console.log("Controller.checkNext();") : (t.$.toc.removeDocs(e.deleted), t.$.mainline.changeSourceSum(-e.deleted.length), t.$.mainline.reload());
}), this.socket.on("removeDocResult", function(e) {
e.success == 1 ? (t.$.toc.removeDocs([ e.doc ]), t.$.mainline.itemDeleted(e)) : t.error("deleting failed");
});
},
...
this.setLoggedIn(!0), this.$.buttonLogin.hide(), this.$.buttonLogout.show(), this.startUp();
},
loggedOut: function(e, t) {
this.setLoggedIn(!1), this.$.buttonLogout.hide(), this.$.buttonLogin.show();
},
showLoginPopup: function(e, t) {
this.$.loginPopup.show();
},
sendLogin: function(e, t) {
this.$.loginPopup.hide();
var n = "username=" + encodeURIComponent(this.$.popupUsername.getValue()) + "&password=" + encodeURIComponent(this.$.popupPassword.getValue());
(new enyo.Ajax({
...
sendLogout: function(e, t) {
(new enyo.Ajax({
url: this.apiEndpoint + "/api/logout"
})).go().response(this, "loggedOut");
},
startUp: function() {
this.loadToc(), this.$.mainline.loadStartView(), this.isNarrow() && this.$.contentPanel.setIndex(1);
},
...
panelDraggable: function(e) {
this.$.contentPanel.setDraggable(!0);
},
panelLocked: function(e) {
this.$.contentPanel.setDraggable(!1);
},
showContenPanel: function(e, t) {
...
showing: !1,
allowHtml: !0,
classes: "view-name news-item source-item"
}, {
name: "scroller",
kind: "Scroller",
onmousewheel: "mousewheel",
...
showing: !1,
components: [ {
classes: "line-action-icon",
kind: "onyx.IconButton",
src: "assets/menu-icon-bookmark.png",
ontap: "showLineAction"
}, {
classes: "line-meta",
components: [ {
name: "newsDate",
...
name: "newsPublisher",
skey: "",
ontap: "loadSourceFromList"
} ]
}, {
classes: "line-title",
onclick: "metaDataClicked",
components: [ {
tag: "a",
name: "newsTitle"
} ]
...
name: "moreItem",
fit: !0,
classes: "line-item-more news-item enyo-border-box",
style: "height:55px",
ontap: "loadNextPage",
showing: !1,
components: [ {
...
name: "spinnerStopped",
kind: "Image",
src: "assets/spinner-stopped.png",
showing: !0
} ]
}, {
name: "clearButton",
...
create: function() {
this.inherited(arguments), document.onmousewheel = enyo.dispatch;
},
mousewheel: function(e, t) {
this.$.scroller.stabilize();
},
clearItems: function() {
this.results = [], this.$.list.setCount(0), this.$.header.setShowing(!1), this.resetPushed(), this.render();
},
clearState: function() {
this.skey = !1, this.source = !1, this.count = 0, this.startDoc = !1, this.$.sourceSum.setShowing(!1);
},
loadList: function() {
var e = {
format: "json"
};
this.skey ? e.id = this.skey : this.$.header.hide(), this.startDoc && (e.startkey = JSON.stringify(this.startDoc)), this.handleSpinner(!0), this.doLoadMainline(e);
},
loadStartView: function() {
this.clearItems(), this.clearState(), this.loadList();
},
reloadEmptyMainline: function() {
this.clearItems(), this.clearState(), this.doLoadNextSource();
},
loadNextPage: function(e, t) {
this.results[this.results.length - 1].title = "<b>loading ...</b>", this.$.list.renderRow(this.results.length - 1), this.loadList();
},
loadSourceFromList: function(e, t) {
var n = this.results[t.index];
this.doSourceSelected({
skey: n.skey,
title: n.publisher
});
},
loadSource: function(e) {
this.clearItems(), this.source = e, this.skey = e.skey, this.startDoc = !1, this.$.header.setContent(e.title), this.loadList();
},
build: function(e, t) {
var n = t.docs;
this.handleSpinner(!1), this.skey && !this.$.header.getShowing() && (this.$.header.setShowing(!0), this.render()), n.length == 0 && this.skey && this.reloadEmptyMainline(), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem",
title: "<b>more</b>"
}), this.lastDoc = n.slice(n.length - 2)) : (this.startDoc = !1, this.lastDoc = n.slice(n.length - 1)), t.append ? (this.results.pop(), this.results = this.results.concat(n), this.lastScroll = this.$.scroller.getScrollBounds().top) : this.results = n, this.$.list.setCount(this.results.length);
},
setupItem: function(e, t) {
var n = this.results[t.index], r = t.item;
return n.deleted == 1 ? r.$.item.setShowing(!1) : (r.$.item.setShowing(!0), n.kind == "NewsItem" ? (r.$.newsDate.setContent(n.date), r.$.newsTitle.setContent(n.title), r.$.newsTitle.setAttribute("href", n.href), r.$.newsBody.setContent(n.body), r.$.newsPublisher.setContent(this.skey ? "" : n.publisher), r.$.newsItem.setShowing(!0), r.$.tweetItem.setShowing(!1), r.$.moreItem.setShowing(!1)) : n.kind == "TweetItem" ? (r.$.tweetDate.setContent(n.date), r.$.tweetByline.setContent(n.byline), r.$.tweetBody.setContent(n.body), r.$.tweetItem.setShowing(!0), r.$.newsItem.setShowing(!1), r.$.moreItem.setShowing(!1)) : n.kind == "MoreItem" && (r.$.newsItem.setShowing(!1), r.$.tweetItem.setShowing(!1), r.$.moreBody.setContent(n.title), r.$.moreItem.setShowing(!0))), !0;
},
addPushedItem: function(e) {
if (!this.skey || this.skey == e.skey) this.pushed.unshift(e), this.setPushedSum();
},
setPushedSum: function() {
var e = this.pushed.length;
e == 1 && this.$.pushedSum.setShowing(!0), this.$.pushedSum.setContent(e);
},
resetPushed: function() {
this.pushed = [], this.$.pushedSum.setShowing(!1), this.$.pushedSum.setContent(0);
},
showPushed: function(e, t) {
this.results = this.pushed.concat(this.results), this.$.list.setCount(this.results.length), this.changeSourceSum(this.pushed.length), this.resetPushed();
},
reload: function() {
this.handleSpinner(!0), this.source ? this.loadSource(this.source) : this.loadStartView();
},
"delete": function(e, t) {
var n = [];
this.results.forEach(function(e) {
e.doc_id != undefined && e.deleted != 1 && n.push({
_id: e.doc_id,
_rev: e.rev,
source: e.skey,
_deleted: !0
...
return t.sum > 0 ? (this.$.sourceSum.setContent(t.sum), this.$.sourceSum.setShowing(!0)) : (this.$.sourceSum.setShowing(!1), this.$.sourceSum.setContent("-"), this.reloadEmptyMainline()), !0;
},
gotSourceInfo: function(e, t) {
t.success == 1 && t.rows.length > 0 && this.setSourceSum(null, {
sum: t.rows[0].value
});
},
changeSourceSum: function(e) {
this.$.sourceSum.getShowing() && this.setSourceSum(null, {
sum: parseInt(this.$.sourceSum.getContent()) + e
});
},
handleSpinner: function(e) {
e ? (this.$.spinnerStopped.hide(), this.$.spinner.show()) : (this.$.spinner.hide(), this.$.spinnerStopped.show());
},
grabberDragstart: function(e, t) {
this.doDragged();
},
grabberDragFinish: function(e, t) {
this.doDragFinished();
},
hrefClicked: function(e, t) {
return t.target.href !== undefined && t.which < 3 && this.openHref(t.target.href), !0;
},
metaDataClicked: function(e, t) {
return (t.originator.name == "tweetDate" || t.originator.name == "newsTitle") && t.which < 3 && this.openHref(this.results[t.index].href), !0;
},
openHref: function(e) {
this.lineActionIndex || window.open(e);
},
showLineAction: function(e, t) {
var n = this.results[t.index];
return this.doShowItemOptions({
item: n
}), this.lineActionIndex = t.index, !0;
},
optionsClosed: function() {
this.lineActionIndex = !1;
},
itemDeleted: function(e) {
this.changeSourceSum(-1), this.handleSpinner(!1), this.results[this.lineActionIndex].deleted = !0, this.$.list.setCount(this.results.length), this.optionsClosed();
}
});
...
components: [ {
kind: "onyx.Grabber",
ontap: "doContentPanel"
} ]
} ],
create: function() {
this.inherited(arguments), enyo.mixin(this, ListExtenders);
},
build: function(e, t) {
var n = [], r = 0;
...
}), this.results = n, this.setTotalSum(r), this.$.list.setCount(this.results.length), this.$.list.scrollToStart(), this.render();
},
setupItem: function(e, t) {
var n = this.results[t.index];
this.$.title.setContent(n.title), n.sum > 0 ? (this.$.sum.setContent(n.sum), this.$.item.setShowing(!0)) : this.$.item.setShowing(!1), n.selected == 1 ? this.$.item.addClass("selected") : this.$.item.hasClass("selected") && this.$.item.removeClass("selected");
},
setTotalSum: function(e) {
this.totalSum = e, this.doTotalSum({
sum: e
});
},
itemWasSelected: function(e) {
this.doSourceSelected(this.results[e]);
},
removeDocs: function(e) {
var t = {}, n = this.results.length, r = 0;
e.forEach(function(e) {
t[e.source] == undefined && (t[e.source] = 0), t[e.source]++, r++;
}), this.setTotalSum(this.totalSum - r);
for (var i = 0; n > i; i++) t[this.results[i].skey] != undefined && (this.results[i].sum -= t[this.results[i].skey], this.results[i].sum < 0 && (this.results[i].sum = 0));
this.$.list.refresh();
},
addPushed: function(e) {
var t = this.results.length, n = !1;
for (var r = 0; t > r; r++) if (this.results[r].skey == e.skey) {
n = r;
break;
}
n > -1 && this.results[n] !== undefined ? this.results[n].sum += 1 : (this.results.push({
skey: e.skey,
sum: 1,
title: e.feed.title
}), this.$.list.setCount(this.results.length)), this.setTotalSum(this.totalSum + 1), this.$.list.refresh();
},
getNextSource: function() {
var e = this.results.length;
for (var t = 0; e > t; t++) if (this.results[t].sum > 0) return this.itemWasSelected(t), this.results[t];
return !1;
}
});
...
name: "desc",
allowHtml: !0,
classes: "item-options-desc"
}, {
name: "itemOptions",
kind: "FittableColumns",
classes: "item-options enyo-center",
showing: !1,
components: [ {
kind: "onyx.Button",
name: "tweetButton",
content: "Tweet",
classes: "onyx-affirmative",
ontap: "showTweetOption",
showing: !1
}, {
kind: "onyx.Button",
name: "tweetReplyButton",
content: "Reply",
classes: "onyx-affirmative",
ontap: "showTweetReplyOption",
showing: !1
}, {
kind: "onyx.Button",
name: "retweetButton",
...
name: "tweetOption",
classes: "tweet-option",
showing: !1,
components: [ {
kind: "onyx.InputDecorator",
classes: "tweet-input-decorator",
components: [ {
kind: "onyx.TextArea",
name: "tweetTextArea",
placeholder: "Enter text here",
onkeypress: "setTweetCharCount"
} ]
}, {
kind: "FittableColumns",
classes: "tweet-form-buttons enyo-center",
components: [ {
kind: "onyx.Button",
content: "Send",
classes: "onyx-affirmative",
...
display: function(e) {
return this.item = e.item, this.setDesc(), this.showItemOptions(), this.slideIn(), !0;
},
slideIn: function() {
return this.animated = !0, this.$.scrim.showAtZIndex(3), this.setOpen(!0), !0;
},
cancelled: function() {
return this.doOptionsClosed(), this.close(), !0;
},
success: function() {
return this.doOptionsClosed(), this.close(), !0;
},
close: function() {
return this.animated = !1, this.setOpen(!1), this.$.scrim.hideAtZIndex(3), !0;
},
setDesc: function() {
var e = "";
this.item.kind === "TweetItem" ? e = this.item.body : e = "<b>" + this.item.publisher + ":</b><br/> " + this.item.title, this.$.desc.setContent(e);
},
showItemOptions: function() {
return this.item.kind === "TweetItem" ? (this.$.tweetButton.hide(), this.$.tweetReplyButton.show(), this.$.retweetButton.show()) : (this.$.tweetButton.show(), this.$.tweetReplyButton.hide(), this.$.retweetButton.hide()), this.$.tweetOption.hide(), this.$.retweetOption.hide(), this.$.itemOptions.show(), !0;
},
showTweetOption: function(e, t) {
var n = this.item.title + " " + this.item.href;
return this.showTweetForm({
text: n
}), !0;
},
showTweetReplyOption: function(e, t) {
var n = "", r = this.item.body.match(/\/\/twitter.com\/[^"]+/g);
return r && (n = "@" + r[0].replace("//twitter.com/", "")), this.showTweetForm({
text: n,
reply: !0
}), !0;
},
showTweetForm: function(e) {
this.close(), this.$.itemOptions.hide(), this.$.tweetOption.show(), this.setTweetTextArea(e.text), this.slideIn();
},
setTweetTextArea: function(e) {
this.$.tweetTextArea.setValue(e), this.setTweetCharCount();
},
setTweetCharCount: function() {
this.$.tweetCharCount.setContent(140 - this.$.tweetTextArea.getValue().length);
},
setTweetSpinner: function(e) {
this.$.tweetCharCount.setShowing(!e), this.$.tweetSpinner.setShowing(e);
},
setRetweetSpinner: function(e) {
this.$.retweetSpinner.setShowing(e);
},
showRetweetOption: function(e, t) {
return this.close(), this.$.itemOptions.hide(), this.$.retweetOption.show(), this.slideIn(), !0;
},
...
return this.doDeleteSingleItem(n), this.close(), !0;
},
sendTweet: function() {
function i(t, n) {
if (n.success === !0) {
var i = decodeURIComponent(encodeURIComponent(e).replace(encodeURIComponent(n.long), n.short));
e = i, r.setTweetTextArea(i), r.setTweetSpinner(!1);
}
}
var e = this.$.tweetTextArea.getValue(), t = e.split(" "), n = t.length, r = this;
if (e.length > 140) for (var s = 0; n > s; s++) t[s].search(/^http[s]?:\/\//i) > -1 && (this.setTweetSpinner(!0), this.doShortUrl({
url: t[s],
callback: i
})); else this.setTweetSpinner(!0), this.doSendTweet({
text: e
});
},
sendRetweet: function() {
this.setRetweetSpinner(!0), this.doSendTweet({
retweet: !0,
id: this.item.doc_id
});
},
tweetSended: function(e, t) {
this.setTweetSpinner(!1), t.success === !0 && (this.setTweetSpinner(!1), this.success());
},
retweetSended: function(e, t) {
this.setRetweetSpinner(!1), t.success === !0 && this.success();
}
}), enyo.kind({
name: "closeIcon",
...
components: [ {
kind: "onyx.IconButton",
src: "assets/progress-button-cancel.png"
} ]
});
...
deleteDocs: function(e) {
var n = {
docs: JSON.stringify(e)
};
return (new enyo.Ajax({
method: "POST",
url: t + "/api/docs/delete/all"
})).go(n);
},
shortUrl: function(e) {
var n = {
...
var n = "text=" + encodeURIComponent(e);
return (new enyo.Ajax({
method: "POST",
url: t + "/api/tweet",
postBody: n
...
sendRetweet: function(e) {
var n = "id=" + encodeURIComponent(e);
return (new enyo.Ajax({
method: "POST",
url: t + "/api/retweet",
postBody: n
...
this.selectedIndex !== !1 && !t && this.highlight(this.selectedIndex, !0), this.selectedIndex = e, this.results[e].selected = !t, this.$.list.prepareRow(e), this.$.list.renderRow(e), this.$.list.lockRow();
},
itemSelected: function(e, t) {
var n = this.$.list.getSelection(), r = t.index;
return this.highlight(r), this.itemWasSelected(r), !0;
}
};
