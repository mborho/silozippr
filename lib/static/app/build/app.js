...
create: function() {
this.inherited(arguments), this.setConnector(new Connector(this.getApiEndpoint())), this.checkSession(), this.$.toc.connector = this.getConnector(), this.$.mainline.connector = this.getConnector();
},
isNarrow: function() {
...
t ? this.$.spinner.show() : this.$.spinner.hide();
},
...
this.setLoggedIn(!0), this.$.buttonLogin.hide(), this.$.buttonLogout.show(), this.$.toc.load(), this.startMainline();
},
startMainline: function() {
this.$.mainline.loadStartView(), this.isNarrow() && this.$.contentPanel.setIndex(1);
},
...
clearItems: function() {
this.results = [], this.$.itemList.setCount(0), this.$.header.setShowing(!1), this.render();
},
clearMoreItem: function() {
var e = this.$.itemList.getComponents(), t = e.slice(e.length - 1);
...
this.skey ? e.id = this.skey : this.$.header.hide(), this.startDoc && (e.startkey = JSON.stringify(this.startDoc)), enyo.Signals.send("onSpinner", !0), this.connector.loadList(e).response(this, "build");
},
...
pullRelease: function() {
var e = !1;
enyo.Signals.send("onSpinner", !0), this.pulled = !0, this.source ? e = function() {
this.loadSource(this.source);
} : e = function() {
this.loadStartView();
}, setTimeout(enyo.bind(this, e), 1e3);
},
pullComplete: function() {
enyo.Signals.send("onSpinner", !1), this.pulled = !1, this.$.itemList.reset();
},
...
setData: function() {
this.$.date.setContent(this.date), this.$.title.setContent(this.title), this.$.title.setAttribute("href", this.href), this.$.body.setContent(this.body), this.combined === !0 && this.$.publisher.setContent(this.publisher);
},
loadSource: function() {
var e = {
skey: this.skey,
...
enyo.Signals.send("onLoadSource", e);
}
});
...
build: function(e, t) {
enyo.forEach(t.rows, this.addItem, this), this.$.tocList.render();
},
addItem: function(e) {
...
unselect: function() {
try {
this.$.tocList.controls.forEach(function(e) {
if (e.hasClass("onyx-selected")) throw e.removeClass("onyx-selected"), Exception;
});
} catch (e) {}
},
sourceSelected: function(e) {
this.doSourceSelected(e);
}
});
...
tapped: function(e, t) {
this.owner.parent.unselect(), this.owner.parent.sourceSelected({
skey: this.skey,
title: this.title
