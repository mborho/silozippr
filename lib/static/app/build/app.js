...
t.retweet === !0 ? this.connector.sendRetweet(t.id).response(this.$.mainline, "retweetSended") : this.connector.sendTweet(t.text).response(this.$.mainline, "tweetSended");
},
...
name: "lineActionPopup",
kind: "onyx.Popup",
scrim: !0,
classes: "line-action-popup",
centered: !0,
modal: !0,
floating: !0,
components: [ {
...
name: "tweetActionPopup",
kind: "onyx.Popup",
scrim: !0,
classes: "tweet-action-popup",
centered: !0,
modal: !0,
floating: !0,
components: [ {
...
var n = this.results[t.index];
return this.lineActionIndex = t.index, n.kind === "TweetItem" ? (this.$.tweetButton.hide(), this.$.tweetReplyButton.show(), this.$.retweetButton.show()) : (this.$.tweetButton.show(), this.$.tweetReplyButton.hide(), this.$.retweetButton.hide()), this.$.tweetActionPopup.hide(), this.$.retweetActionPopup.hide(), this.$.lineActionPopup.show(), !0;
},
hideLineAction: function(e, t) {
return this.lineActionIndex = !1, this.$.lineActionPopup.hide(), !0;
},
...
var e = this.results[this.lineActionIndex], t = e.title + " " + e.href;
return this.displayTweetPopup(t), !0;
},
showTweetReplyPopup: function() {
var e = this.results[this.lineActionIndex], t = "", n = e.body.match(/\/\/twitter.com\/[^"]+/g);
return n && (t = "@" + n[0].replace("//twitter.com/", "")), this.displayTweetPopup(t), !0;
},
displayTweetPopup: function(e) {
this.$.lineActionPopup.hide(), this.setTweetTextArea(e), this.$.tweetActionPopup.show(), this.$.tweetTextArea.focus();
},
hideTweetPopup: function(e, t) {
return this.lineActionIndex = !1, this.$.tweetActionPopup.hide(), !0;
},
showRetweetPopup: function() {
return this.$.lineActionPopup.hide(), this.$.retweetActionPopup.show(), this.sendRetweet(), !0;
},
hideRetweetPopup: function() {
this.lineActionIndex = !1, this.$.retweetActionPopup.hide();
},
setTweetTextArea: function(e) {
this.$.tweetTextArea.setValue(e), this.$.tweetTextArea.focus(), this.setTweetCharCount();
},
...
console.log(n);
if (n.success === !0) {
var r = decodeURIComponent(encodeURIComponent(e).replace(encodeURIComponent(n.long), n.short));
e = r, s.setTweetTextArea(r), s.setTweetSpinner(!1);
}
}
var e = this.$.tweetTextArea.getValue(), t = this.lineActionIndex, n = this.results[t], r = e.split(" "), i = r.length, s = this;
if (e.length > 140) for (var u = 0; i > u; u++) r[u].search(/^http[s]?:\/\//i) > -1 && (this.setTweetSpinner(!0), this.doShortUrl({
url: r[u],
callback: o
...
var e = this.results[this.lineActionIndex];
this.doSendTweet({
retweet: !0,
id: e.doc_id
});
...
t.success === !0 && (this.setTweetSpinner(!1), this.hideTweetPopup());
},
retweetSended: function(e, t) {
t.success === !0 && this.hideRetweetPopup();
}
});
