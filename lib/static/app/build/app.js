...
(a.kind == "TweetItem" || a.kind == "NewsItem") && a.destroy();
...
this.skey ? a.id = this.skey : this.$.header.hide(), (new enyo.Ajax({
...
a == 1 ? this.$.more.show() : this.$.more.hide(), console.log("managed");
},
build: function(a, b) {
enyo.forEach(b.docs, this.addItem, this), this.manageMoreItem(b.more), this.$.itemList.render();
},
addItem: function(a) {
