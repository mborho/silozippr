...
this.connector.loadList(t).response(this.$.mainline, "build");
},
deleteItems: function(e, t) {
this.connector.deleteDocs(t).response(this, "docsDeleted");
},
deleteSingleItem: function(e, t) {
console.log(t), this.connector.deleteDocs(t).response(this, "singleDocDeleted");
},
docsDeleted: function(e, t) {
t.success == 1 && (this.$.mainline.reload(), this.$.toc.removeDocs(t.deleted));
},
singleDocDeleted: function(e, t) {
t.success == 1 && this.$.toc.removeDocs(t.deleted);
},
...
this.isNarrow() && this.$.contentPanel.setIndex(1), this.$.mainline.loadSource(t);
},
...
controlSpinner: function(e, t) {
t ? (this.$.spinnerStopped.hide(), this.$.spinner.show()) : (this.$.spinner.hide(), this.$.spinnerStopped.show());
},
...
var e = this.$.list.getComponents(), t = e.slice(e.length - 1);
t.length > 0 && t[0].name === "more" && t[0].destroy();
},
loadList: function() {
var e = {
format: "json"
};
this.skey ? e.id = this.skey : this.$.header.hide(), this.startDoc && (e.startkey = JSON.stringify(this.startDoc)), enyo.Signals.send("onSpinner", !0), this.doLoadMainline(e);
},
loadStartView: function() {
this.clearItems(), this.skey = !1, this.source = !1, this.count = 0, this.startDoc = !1, this.loadList();
},
...
build: function(e, t) {
var n = t.docs;
enyo.Signals.send("onSpinner", !1), this.pulled && this.$.list.completePull(), n.length == 0 && this.loadStartView(), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem"
...
reload: function() {
enyo.Signals.send("onSpinner", !0), this.source ? this.loadSource(this.source) : this.loadStartView();
},
"delete": function() {
var e = [];
this.results.forEach(function(t) {
t.doc_id != undefined && t.deleted != 1 && e.push({
_id: t.doc_id,
_rev: t.rev,
source: t.skey,
_deleted: !0
});
}), this.doDeleteItems(e), this.$.list.hide();
},
...
enyo.Signals.send("onSpinner", !1), this.pulled = !1, this.$.list.reset();
},
...
}), this.results = n, this.$.list.setCount(this.results.length), this.$.list.scrollToStart(), this.render();
},
setupItem: function(e, t) {
var n = this.results[t.index];
...
var t = {}, n = this.results.length;
e.forEach(function(e) {
t[e.source] == undefined && (t[e.source] = 0), t[e.source]++;
});
for (var r = 0; n > r; r++) t[this.results[r].skey] != undefined && (this.results[r].sum -= t[this.results[r].skey], this.results[r].sum < 0 && (this.results[r].sum = 0));
this.$.list.refresh();
}
});
