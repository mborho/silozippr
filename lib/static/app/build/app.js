...
loadSourceContent: function(e) {
this.isNarrow() && this.$.contentPanel.setIndex(1), this.$.mainline.loadSource(e);
}
});
...
content: "",
showing: !1,
classes: "news-item source-item enyo-border-box"
}, {
name: "spinner",
kind: "Image",
...
clearItems: function() {
this.results = [], this.$.itemList.setCount(0), this.$.itemList.reset(), this.$.header.setShowing(!1);
},
...
this.skey ? e.id = this.skey : this.$.header.hide(), this.startDoc && (e.startkey = JSON.stringify(this.startDoc)), enyo.Signals.send("onSpinner", !0), (new enyo.Ajax({
url: this.owner.getApiEndpoint() + "/api/list/docs"
})).go(e).response(this, "build");
},
...
name: "more",
kind: "MoreItem"
}), this.lastDoc = n.slice(n.length - 2)) : (this.startDoc = !1, this.lastDoc = n.slice(n.length - 1)), this.skey && this.$.header.setShowing(!0), t.append ? (this.results.pop(), this.results = this.results.concat(n), this.$.itemList.setCount(this.results.length), this.$.itemList.refresh()) : (this.results = n, this.$.itemList.setCount(this.results.length), this.$.itemList.reset());
},
...
addItem: function(e) {
e.combined = !this.skey, this.$.itemList.createComponent(e), this.count++;
},
pullRelease: function() {
var e = !1;
this.pulled = !0, this.source ? e = function() {
...
this.pulled = !1, this.$.itemList.reset();
}
});
...
this.owner.loadSourceContent(e);
}
});
