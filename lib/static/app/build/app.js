...
create: function() {
this.inherited(arguments), this.setConnector(new Connector(this.getApiEndpoint())), this.$.tools.setConnector(this.connector), this.checkSession();
},
isNarrow: function() {
...
this.$.tools.showItemOptions(t), this.$.tools.open || this.$.tools.setOpen(!0);
},
...
this.changeSourceSum(-1), this.handleSpinner(!1), this.results[this.lineActionIndex].deleted = !0, this.$.list.setCount(this.results.length);
}
});
...
return this.item = e.item, this.item.kind === "TweetItem" ? (this.$.tweetButton.hide(), this.$.tweetReplyButton.show(), this.$.retweetButton.show()) : (this.$.tweetButton.show(), this.$.tweetReplyButton.hide(), this.$.retweetButton.hide()), this.$.tweetOption.hide(), this.$.retweetOption.hide(), this.$.itemOptions.show(), !0;
},
...
this.animated = !1, this.close(), this.$.itemOptions.hide(), this.$.tweetOption.show(), this.setTweetTextArea(e.text), this.animated = !0, this.setOpen(!0);
},
...
return this.animated = !1, this.close(), this.$.itemOptions.hide(), this.$.retweetOption.show(), this.animated = !0, this.setOpen(!0), !0;
},
...
this.setTweetSpinner(!1), t.success === !0 && (this.setTweetSpinner(!1), this.close());
},
retweetSended: function(e, t) {
this.setRetweetSpinner(!1), t.success === !0 && this.close();
}
});
