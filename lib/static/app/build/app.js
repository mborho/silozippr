...
itemTapped: function(e, t) {
var n = !1;
if (t.target.tagName == "A" && t.target.href) n = t.target.href; else if (t.originator.name == "tweetDate" || t.originator.name == "newsTitle") n = this.results[t.index].href;
return n && this.openHref(n), !0;
},
openHref: function(e) {
window.open(e, "", "");
}
