...
build: function(e, t) {
var n = t.docs;
this.handleSpinner(!1), this.skey && !this.$.header.getShowing() && (this.$.header.setShowing(!0), this.render()), n.length == 0 && this.loadStartView(), t.more !== !1 ? (this.startDoc = t.more, n.push({
name: "more",
kind: "MoreItem",
title: "<b>more</b>"
