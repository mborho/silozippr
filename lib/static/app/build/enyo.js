...
try {
if (window.XDomainRequest && !e.headers && !this.inOrigin(e.inUrl) && !/^file:\/\//.test(window.location.href)) return new XDomainRequest;
} catch (t) {}
try {
...
i = this.postBody || i, this.method != "GET" && (this.method === "POST" && window.FormData && i instanceof FormData || (o["Content-Type"] = this.contentType)), enyo.mixin(o, this.headers);
try {
