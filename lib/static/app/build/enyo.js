...
enyo.machine = {
sheet: function(e) {
document.write('<link href="' + e + '" media="screen" rel="stylesheet" type="text/css" />');
},
script: function(e, t, n) {
document.write('<script src="' + e + '"' + (t ? ' onload="' + t + '"' : "") + (n ? ' onerror="' + n + '"' : "") + "></scri" + "pt>");
},
inject: function(e) {
...
if (n && r !== null && i == null) throw "enyo.kind: Attempt to subclass an undefined kind. Check dependencies for [" + t + "].";
...
this.controls.push(e), this.addChild(e);
},
...
addChild: function(e) {
this.controlParent ? this.controlParent.addChild(e) : (e.setParent(this), this.children[this.prepend ? "unshift" : "push"](e));
},
...
return t.send(e.body || null), r || t.onreadystatechange(t), t;
},
...
request: function(e) {
var t = this.url.split("?"), n = t.shift() || "", r = t.join("?").split("&"), i = enyo.isString(e) ? e : enyo.Ajax.objectToQuery(e);
this.method == "GET" && (i && (r.push(i), i = null), this.cacheBust && r.push(Math.random()));
var s = [ n, r.join("&") ].join("?"), o = {
"Content-Type": this.contentType
};
enyo.mixin(o, this.headers), this.xhr = enyo.xhr.request({
url: s,
method: this.method,
...
}), document.elementFromPoint || (this.findTarget = function(e, t) {
...
delegateEvent: function(e, t, n, r, i) {
e == this && (e = this.owner.owner), this.inherited(arguments, [ e, t, n, r, i ]);
}
});
...
down: function(e, t) {
this.modal && !t.dispatchTarget.isDescendantOf(this) && t.preventDefault();
},
tap: function(e, t) {
if (this.autoDismiss && !t.dispatchTarget.isDescendantOf(this)) return this.hide(), !0;
},
