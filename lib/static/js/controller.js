...
var Controller = (function(socket, toc) {
    ...
    function _gotItemsByFeed(data, mainView) { 
        ...
        if(mainView === true) {
            ...
            _setTotalViewDocs(_toc.getSourceCount(_feedView));
            _showViewElements();
        };
        $('#expand').show();
    };
    ...
    return {          
        ...
        getItemsByFeed: function(source_key, feed_title, start_key) {            
            var query = "id="+encodeURIComponent(source_key);
