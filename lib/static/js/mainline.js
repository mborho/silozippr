...
Mainline.prototype.addClickHandler = function(elem) {
    ...
    var links = elem.find('a[class!="line-del"]');
    links.unbind("click");
...
Mainline.prototype.addPushed = function() {
    ...
    if(div.length == 0) {
        this.pushed = 0;
        div = $('<div class="grid-10 round-5 line-item-more" id="pushedBox">');    
...
Mainline.prototype.showSpinner = function() {
    this.container.html('<div class="grid-10 line-item spinning" id="main-spinner">&#160;</div>');
};
